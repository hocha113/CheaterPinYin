...
namespace CheaterPinYin
{
    internal class CheatSheetNPCSearchModifier
    {
        ...
        internal int[] Get_activeSlots_Field(object obj) {
            LoadNPCViewInfo(obj);
            return (int[])activeSlots_FieldInfo.GetValue(npcView_Instance);
        }

        internal void Set_activeSlots_Field(object obj, int[] newList) {
            LoadNPCViewInfo(obj);
            activeSlots_FieldInfo.SetValue(npcView_Instance, newList);
        }

        internal int[] Get_selectedCategory_Property(object obj) {
            LoadNPCViewInfo(obj);
            return (int[])selectedCategory_Property.GetValue(npcView_Instance);
        }

        internal void Run_NPCView_ReorderSlots_MethodValue(object obj) {
            LoadNPCViewInfo(obj);
            reorderSlots_Method.Invoke(npcView_Instance, null);
        }
